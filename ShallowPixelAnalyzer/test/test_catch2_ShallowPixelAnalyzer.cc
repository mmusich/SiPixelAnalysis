...
static constexpr auto s_tag = "[ShallowPixelAnalyzer]";

TEST_CASE("Standard checks of ShallowPixelAnalyzer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("ShallowPixelAnalyzer"
